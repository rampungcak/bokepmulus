...
A live demo of the project is available at [https://bokepmulus.pages.dev](https://bokepmulus.pages.dev/).
...
1. Fork the [repository](https://github.com/rampungcak/bokepmulus/fork) on GitHub.
